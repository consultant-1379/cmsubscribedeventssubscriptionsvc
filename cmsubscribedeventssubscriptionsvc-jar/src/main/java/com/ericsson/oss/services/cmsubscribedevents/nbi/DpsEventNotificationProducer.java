...
/**
 * Sends VES notifications via HTTP for DpsDataChangedEvents.
 *
 */
public class DpsEventNotificationProducer extends EventNotificationProducer<DpsDataChangedEvent> {
    ...
    public String buildNotificationTypeModel(final OperationType operationType, final String subscriptionNotificationType,
        ...
        return vesEventBuilder.buildDpsVesEventString(operationType, subscriptionNotificationType, event);
    }
}
